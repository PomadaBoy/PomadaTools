# ============================================================
#  pyRevit Script — Override Graphic Settings
#  Place this file as script.py inside your pyRevit extension
#  button folder (.pushbutton)
# ============================================================
...
def to_element_id(pattern_element):
    ...
    if hasattr(pattern_element, 'Id'):
        return ElementId(pattern_element.Id)
    return None
